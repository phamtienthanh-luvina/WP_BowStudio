...
class mtsGoogleTypography {
	...
	function help_tab() {
		...
		$adding_title					= __('Adding A Collection', 'sociallyviral' );
		$adding_content				= '<p>'.__('To add a new font for use on your site. Click the "Add New" button on the top left of the page near the "Google Typography" title.', 'sociallyviral' ).'</p>';
		$adding_content			 .= '<p>'.__('Once added, a new font row will appear on the page below. Next you can continue to customize your font (more info in the "Customizing" help tab).', 'sociallyviral' ).'</p>';
		//$adding_content			 .= '<p><a href="https://vimeo.com/67957799" target="_blank">'.__('Watch The Video Tutorial &rarr;', 'sociallyviral' ).'</a></p>';
		$customizing_title 		= __('Customizing', 'sociallyviral' );
		$customizing_content	= '<p>'.__('Customizing fonts is easy; after adding a new font row you can then customize the following font attributes:', 'sociallyviral' ).'</p>';
		$customizing_content .= '<ul><li><b>'.__('Preview Text', 'sociallyviral' ).'</b> - '.__('Used for live previewing your changes. This text does not appear anywhere on your website.', 'sociallyviral' ).'</li><li><b>Preview Background Color</b> - Allows you to swap between light and dark backgrounds when previewing this font.</li><li><b>'.__('Font Family', 'sociallyviral' ).'</b> - '.__('The font family to use for this font. Choose from a real-time list of all available Google Fonts.', 'sociallyviral' ).'</li><li><b>'.__('Font Variant', 'sociallyviral' ).'</b> - '.__('The variant to use for this font. Note: Each font has it\'s own variant options.', 'sociallyviral' ).'</li><li><b>'.__('Font Size', 'sociallyviral' ).'</b> - '.__('The size you would like this font to be.', 'sociallyviral' ).'</li><li><b>'.__('Font Color', 'sociallyviral' ).'</b> - '.__('The color you\'d like to use for this font.', 'sociallyviral' ).'</li><li><b>'.__('CSS Selectors', 'sociallyviral' ).'</b> - '.__('The HTML tags or CSS selectors you\'d like this font to apply to (more info in the "CSS Selectors" help tab). You can specify multiple selectors separated by comma\'s. Ex: h1, #some_id, .some_class', 'sociallyviral' ).'</li></ul>';
		$selectors_title 			= __('CSS Selectors', 'sociallyviral' );
		$selectors_content		= '<p>' . __('CSS Selectors are used to hook your font rows into your actual website. Once you\'ve added, customized, and defined CSS selectors for your fonts, Google Typography will automatically insert all the necessary CSS into your website.', 'sociallyviral' ) . '</p>';
		$selectors_content		= '<p>' . __('Here are some examples of the selectors you can use:', 'sociallyviral' ) . '</p>';
		$selectors_content	 .= '<ul><li><b>'.__('IDs', 'sociallyviral' ).':</b> '.__('#selector', 'sociallyviral' ).'</li><li><b>'.__('Classes:', 'sociallyviral' ).':</b> '.__('.selector', 'sociallyviral' ).'</li><li><b>'.__('HTML Tags', 'sociallyviral' ).':</b> '.__('span', 'sociallyviral' ).'</ul>';
		$selectors_content	 .= '<p><b>'.__('Example', 'sociallyviral' ).':</b> '.__('#selector span.date', 'sociallyviral' ).'</p>';
	...
	function plugin_link($links, $file) {
		if ( $file == 'google-typography/google-typography.php' ) {
			$links['settings'] = sprintf( '<a href="%s"> %s </a>', admin_url( 'themes.php?page=typography' ), __( 'Settings', 'sociallyviral' ) );
		}
		return $links;
	}
	...
	function options_ui() {
		...
		$title								= __('Theme Typography', 'sociallyviral' );
		$loading							= __('Loading Your Collections', 'sociallyviral' );
		$add_new        			= __('Add New Collection', 'sociallyviral' );
		$reset        				= __('Reset Collections', 'sociallyviral' );
		$preview_text   			= __('Type in some text to preview...', 'sociallyviral' );
		$collection_title 			= __('New Collection', 'sociallyviral' );
        //$this->preview_text = $preview_text; // to pass it to JS
		$preview_hint   			= __('Preview Background Color', 'sociallyviral' );
		//$font_family_title  	= __('Font family...', 'sociallyviral' );
        $std_font_family_title  	= __('Standard Fonts', 'sociallyviral' );
        $google_font_family_title  	= __('Google Fonts', 'sociallyviral' );
		$font_variant_title 	= __('Variant...', 'sociallyviral' );
		$font_size_title 			= __('Size...', 'sociallyviral' );
        $backup_font_title          = __('Fallback:', 'sociallyviral' );
		$css_selectors_title	= __('CSS Selectors:', 'sociallyviral' );
        $additional_css_title	= __('Additional CSS:', 'sociallyviral' );
		$delete_button_text   = __('Delete', 'sociallyviral' );
		$save_button_text			= __('Save', 'sociallyviral' );
		
		$welcome_title 				= __('Theme Typography', 'sociallyviral' );
		$welcome_subtitle			= __('Get started in 3 steps.', 'sociallyviral' );//.'<a href="https://vimeo.com/67957799" target="_blank">'.__('Watch the video tutorial &#x2192;', 'sociallyviral' ).'</a>';
		$step_1_title 				= __('1. Pick A Font', 'sociallyviral' );
		$step_1_desc					= __('Choose from any of the 600+ Google Fonts.', 'sociallyviral' );
		$step_2_title 				= __('2. Customize It', 'sociallyviral' );
		$step_2_desc					= __('Pick a size, variant, color and more.', 'sociallyviral' );
		$step_3_title 				= __('3. Attach It', 'sociallyviral' );
		$step_3_desc					= __('Attach your font to any CSS selector(s).', 'sociallyviral' );
		$year									= date("Y");
        $themename = MTS_THEME_NAME;
        
        $character_sets_title = __('Character sets', 'sociallyviral' );
        $character_sets_desc = __('Choose the character sets you wish to include. Please note that not all sets are available for all fonts.', 'sociallyviral' );
        ...
        $character_sets = array(
            'latin' => __('Latin', 'sociallyviral' ),
            'latin-ext' => __('Latin Extended', 'sociallyviral' ),
            'cyrillic' => __('Cyrillic', 'sociallyviral' ),
            'cyrillic-ext' => __('Cyrillic Extended', 'sociallyviral' ),
            'greek' => __('Greek', 'sociallyviral' ),
            'greek-ext' => __('Greek Extended', 'sociallyviral' ),
            'vietnamese' => __('Vietnamese', 'sociallyviral' ),
            'khmer' => __('Khmer', 'sociallyviral' ),
            'devanagari' => __('Devanagari', 'sociallyviral' ),
        );
...
EOT;
	...
	function admin_scripts() {
		...
		wp_localize_script('google-typography', 'googletypography', array(
	            'reset_confirm' => __("Are you sure you want to revert to the theme's default collections? Note: You will lose any custom collections you've created.", 'sociallyviral' ),
	            'delete_confirm' => __("Are you sure you want to delete this collection?", 'sociallyviral' )
	        ));
