    ...
    function mts_social_button( $button ) {
        ...
        switch ( $button ) {
            ...
            ?>
                <!-- Twitter -->
                <li class="twitter">
                    <a target="_blank" href="http://twitter.com/home?status=<?php echo urlencode( get_the_title() ); ?> <?php echo urlencode( get_the_permalink() ); ?><?php echo empty( $mts_options['mts_twitter_username'] ) ? '' : ( ' via @' . $mts_options['mts_twitter_username'] ); ?>" class="popup">
